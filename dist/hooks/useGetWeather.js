...
const useGetWeather = () => {
    ...
    const fetchWeatherData = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            setLoading(true);
            const resp = yield fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=${weather_Api_Key}&units=metric`);
    ...
    (0, react_1.useEffect)(() => {
        const fetchLocation = () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let location1 = yield Location.getCurrentPositionAsync({});
